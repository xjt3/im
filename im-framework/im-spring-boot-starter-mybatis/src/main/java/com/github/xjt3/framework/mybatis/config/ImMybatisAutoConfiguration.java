package com.github.xjt3.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.github.xjt3.framework.common.util.json.JsonUtils;
import com.github.xjt3.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${im.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class ImMybatisAutoConfiguration {
