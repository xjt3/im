package com.github.xjt3.framework.web.config;
...
import com.github.xjt3.framework.web.core.filter.CacheRequestBodyFilter;
import com.github.xjt3.framework.web.core.filter.DemoFilter;
import com.github.xjt3.framework.web.core.handler.GlobalExceptionHandler;
import com.github.xjt3.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class ImWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "im.demo", havingValue = "true")
