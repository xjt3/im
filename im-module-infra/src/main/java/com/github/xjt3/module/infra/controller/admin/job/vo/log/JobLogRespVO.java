package com.github.xjt3.module.infra.controller.admin.job.vo.log;
...
import com.github.xjt3.module.infra.enums.DictTypeConstants;
...
public class JobLogRespVO {
    ...
    @Schema(description = "处理器的参数", example = "im")
