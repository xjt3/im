 ...
 *      1）Spring Async：
 *          {@link com.github.xjt3.framework.quartz.config.ImAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 ImSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.github.xjt3.framework.tenant;
