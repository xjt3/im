package com.github.xjt3.module.system.service.social;
...
import com.github.xjt3.framework.common.util.cache.CacheUtils;
import com.github.xjt3.framework.common.util.http.HttpUtils;
import com.github.xjt3.framework.common.util.object.BeanUtils;
import com.github.xjt3.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.github.xjt3.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.github.xjt3.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.github.xjt3.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.github.xjt3.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.github.xjt3.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.github.xjt3.module.system.dal.dataobject.social.SocialClientDO;
import com.github.xjt3.module.system.dal.mysql.social.SocialClientMapper;
import com.github.xjt3.module.system.dal.redis.RedisKeyConstants;
import com.github.xjt3.module.system.enums.social.SocialTypeEnum;
import com.github.xjt3.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.github.xjt3.framework.common.util.collection.MapUtils.findAndThen;
import static com.github.xjt3.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.github.xjt3.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.github.xjt3.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${im.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${im.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/im-cloud/pulls/230
