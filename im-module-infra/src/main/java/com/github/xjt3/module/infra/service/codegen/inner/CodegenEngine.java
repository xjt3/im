package com.github.xjt3.module.infra.service.codegen.inner;
...
import com.github.xjt3.framework.apilog.core.annotation.ApiAccessLog;
import com.github.xjt3.framework.apilog.core.enums.OperateTypeEnum;
...
import com.github.xjt3.framework.common.util.date.DateUtils;
import com.github.xjt3.framework.common.util.date.LocalDateTimeUtils;
import com.github.xjt3.framework.common.util.object.BeanUtils;
import com.github.xjt3.framework.common.util.object.ObjectUtils;
import com.github.xjt3.framework.common.util.string.StrUtils;
import com.github.xjt3.framework.excel.core.annotations.DictFormat;
import com.github.xjt3.framework.excel.core.convert.DictConvert;
import com.github.xjt3.framework.excel.core.util.ExcelUtils;
import com.github.xjt3.framework.mybatis.core.dataobject.BaseDO;
...
import com.github.xjt3.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.github.xjt3.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.github.xjt3.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.github.xjt3.module.infra.enums.codegen.CodegenSceneEnum;
import com.github.xjt3.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.github.xjt3.module.infra.enums.codegen.CodegenVOTypeEnum;
import com.github.xjt3.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    /**
     * 是否为 im-cloud 项目，用于解决 Boot 和 Cloud 的 api 模块兼容性问题
     *
     * true  - 需要有 im-module-xxx-api 模块
    ...
    public CodegenEngine() {
        ...
        this.cloudEnable = ClassUtils.isPresent("com.github.xjt3.module.infra.framework.rpc.config.RpcConfiguration",
    ...
    private Map<String, String> getTemplates(Integer frontType) {
        ...
        if (Boolean.FALSE.equals(cloudEnable)) {
            SERVER_TEMPLATES.forEach((templatePath, filePath) -> {
                filePath = StrUtil.replace(filePath, "/im-module-${table.moduleName}-api", "");
                filePath = StrUtil.replace(filePath, "/im-module-${table.moduleName}-server", "");
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "im-module-${table.moduleName}/" + // 顶级模块
                "im-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "im-module-${table.moduleName}/" + // 顶级模块
                "im-module-${table.moduleName}-server/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "im-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "im-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3UniappFilePath(String path) {
        return "im-ui-${sceneEnum.basePackage}-uniapp/" + // 顶级目录
                "src/" + path;
    }

    private static String vue3VbenFilePath(String path) {
        return "im-ui-${sceneEnum.basePackage}-vben/" + // 顶级目录
                "src/" + path;
    }
