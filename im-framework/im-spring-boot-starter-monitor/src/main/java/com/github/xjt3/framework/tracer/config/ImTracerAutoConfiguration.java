...
import com.github.xjt3.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "im.tracer", value = "enable", matchIfMissing = true)
public class ImTracerAutoConfiguration {
