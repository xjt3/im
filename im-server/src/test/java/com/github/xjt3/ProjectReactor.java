...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.github.xjt3";
    private static final String ARTIFACT_ID = "im";
    private static final String PACKAGE_NAME = "com.github.xjt3";
    private static final String TITLE = "IM";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.github.xjt3";
        String artifactIdNew = "im";
        String packageNameNew = "com.github.xjt3";
        String titleNew = "IM";
        String projectBaseDirNew = "C:/Users/jintaox/Desktop/im"; // 一键改名后，“新”项目所在的目录
